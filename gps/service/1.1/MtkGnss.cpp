...
float MtkGnss::getCarrierFrequency(::GnssConstellationType type) {
    float frequency = CARRIER_FREQ_GPS_L1;
    switch(type) {
        case GNSS_CONSTELLATION_GPS:
            frequency = (float)CARRIER_FREQ_GPS_L1;
             break;
        case GNSS_CONSTELLATION_GLONASS:
            frequency = (float)CARRIER_FREQ_GLO_L1;
            break;
        case GNSS_CONSTELLATION_BEIDOU:
            frequency = (float)CARRIER_FREQ_BD_B1;
            break;
        case GNSS_CONSTELLATION_GALILEO:
            frequency = (float)CARRIER_FREQ_GAL_E1;
            break;
